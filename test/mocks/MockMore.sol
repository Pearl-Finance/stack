 ...
 */
contract MockMore is BorrowToken, OFTUpgradeable, ReentrancyGuardUpgradeable, UUPSUpgradeable, CommonErrors {
    ...
    function flashLoan(IERC3156FlashBorrower, address, uint256, bytes calldata) public pure override returns (bool) {
        return false;
    }
