...
import {IWETH9} from "src/periphery/interfaces/IWETH9.sol";
import {BorrowToken} from "src/tokens/BorrowToken.sol";
...
import {InterestAccrualMath, InterestAccruingAmount} from "src/libraries/InterestAccrualMath.sol";
    ...
    UUPSUpgradeable
{
        ...
        noRebase
    {
        ...
        if (swapAmountIn < withdrawalAmount) {
            unchecked {
                uint256 delta = withdrawalAmount - swapAmountIn;
